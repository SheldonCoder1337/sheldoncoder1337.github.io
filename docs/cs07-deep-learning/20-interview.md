...
## AI Application Development Engineer [60Q&A]

### 第一层：基础认知（Why / What）【10 题】
...
Q6. 在 AI 应用中，你如何理解 Python 的“简单”与“失控”之间的关系？
...
Q8. 你觉得 Python 更适合“一次性交付”还是“长期演进”的 AI 项目？
...
Q9. 在 Python AI 项目中，你如何避免“技术债”快速累积？
...
### 第二层：Python 核心语言能力【16 题】

Q11. 你在什么场景下会用 Python 的生成器？
...
Q12. 你如何理解 Python 的浅拷贝和深拷贝？在 AI 项目中踩过坑吗？
...
Q14. 你在 Python 中如何处理异常？会随便 try-except 吗？
...
Q15. 你如何在 Python 中管理配置，而不是写死在代码里？
...
Q18. 你怎么看 Python 的 lambda 和列表推导式？
...
Q20. 你如何看待 Python 的“鸭子类型”在工程中的利弊？
...
Q24. 你如何看待 Python 的反射能力（getattr 等）？
...
Q25. Python 中装饰器在 AI 工程中有哪些实际用法？
...
### 第三层：Python 工程化能力【16 题】

Q27. 你如何组织一个中大型 Python 项目的目录结构？
...
Q35. 你如何设计 Python 项目的“核心域”和“边缘域”？
...
### 第四层：Python + AI 应用实战【12 题】

Q43. 你如何用 Python 组织一次完整的模型调用流程？
...
Q45. 你如何用 Python 实现简单的规则 + AI 混合逻辑？
...
Q50. 你如何用 Python 降低 AI 调用失败对业务的影响？
...
Q51. Python 中你如何实现“多步骤 AI 任务”的中断与恢复？
...
Q52. 你如何在 Python 中限制 AI 功能的“使用范围”？
...
Q53. Python 中你如何处理 AI 返回的“不完整结果”？
...
Q54. 你如何在 Python 中支持 AI 逻辑的快速试错？
...
### 第五层：进阶与加分项（Python 视角）【6 题】

Q55. 你如何看待 Python 在 AI 应用中的“性能瓶颈”问题？
...
Q57. 面试官眼中，Python AI 工程师最重要的能力是什么？
...
Q58. 你如何看待 Python 在 AI 应用中的“天花板”？
...
Q59. 你如何判断一个 Python AI 项目“是否值得继续演进”？
...
Q60. 在你看来，Python AI 工程师的“高级阶段”体现在哪里？
...
Q6. 在 PyTorch 中，你如何理解“前向是业务逻辑，反向是系统能力”这句话？
...
Q7. 你如何理解 PyTorch 的“动态图”对模型设计自由度的影响？
...
Q8. 在 PyTorch 项目中，你如何区分“实验代码”和“可复用模型代码”？
...
Q9. 你怎么看 PyTorch 对 Python 特性的高度依赖？
...
Q10. 在你看来，PyTorch 新手最容易形成的错误认知是什么？
...
Q13. 你如何区分 `model.train()` 和 `model.eval()` 的作用？
...
Q14. PyTorch 中 `nn.Module` 的设计思想你是怎么理解的？
...
Q16. 你怎么看待 PyTorch 的 in-place 操作？
...
Q19. 你如何理解 PyTorch 中 Tensor 的“视图（view）”和“拷贝”的区别？
...
Q21. PyTorch 中计算图是如何被释放的？你踩过什么坑？
...
Q22. 你如何理解 PyTorch 中的“叶子节点 Tensor”？
...
Q23. PyTorch 中你如何判断一个 Tensor 是否在计算图中？
...
Q24. 你如何看待 PyTorch 中对标量 loss 使用 `item()`？
...
Q25. 你在 PyTorch 中是如何避免“无意中构建计算图”的？
...
Q26. PyTorch 中你如何处理 Tensor 的 device 不一致问题？
...
Q30. PyTorch 训练中 loss 不下降，你通常怎么排查？
...
Q33. 你如何看待 PyTorch 的 DataLoader 设计？
...
Q35. 你如何在 PyTorch 中实现梯度累积？适合什么场景？
...
Q36. 你如何理解学习率在 PyTorch 训练中的“第一优先级”？
...
Q42. 你如何在 PyTorch 中评估一次训练“是否值得继续跑”？
...
Q50. PyTorch 中你如何处理 loss 为 NaN 的情况？
...
Q56. 你认为 PyTorch 工程师的“高级能力”体现在哪？
...
Q57. 面试官如何通过 PyTorch 问题判断你是否“值得培养”？
...
Q58. 你如何看待 PyTorch 在“实验速度”和“工程稳定性”之间的取舍？
...
Q59. 你认为 PyTorch 深度学习工程师最核心的能力是什么？
...
Q60. 面试官通过 PyTorch 训练问题，最想判断你什么能力？
...
Q6. 为什么 Transformer 能成为大模型的基础架构，而不是 RNN / CNN？
    面试官为什么问这个问题：  
...
Q7. 你怎么区分 Transformer 架构 和 GPT / BERT 这些具体模型？
    面试官为什么问这个问题：  
...
Q8. 从工程视角看，Transformer 解决的是“建模问题”还是“系统问题”？
    面试官为什么问这个问题：  
...
Q9. 为什么说 Transformer 是“架构”，而不是一种具体算法？
    面试官为什么问这个问题：  
...
Q10. 如果不用“注意力机制”这个词，你会怎么向产品或业务解释 Transformer？
    面试官为什么问这个问题：  
...
Q11. Transformer 里“残差连接”不是装饰，它在工程上到底救了什么？
    面试官为什么问这个问题：  
...
Q12. 为什么 Transformer 的 FFN（MLP）层看起来“很笨重”，但又不能轻易砍掉？
    面试官为什么问这个问题：  
...
Q13. 你怎么解释“Transformer 结构很统一”这件事，对工业落地有什么直接好处？
    面试官为什么问这个问题：  
...
Q14. 你如何用通俗语言解释 Self-Attention 的计算过程？
    面试官为什么问这个问题：  
...
Q16. Multi-Head Attention 的价值到底是什么？
    面试官为什么问这个问题：  
    很多人会背定义，但理解不深。
...
Q17. 为什么 Transformer 需要 Position Encoding？
    面试官为什么问这个问题：  
    这是序列建模的核心问题。
...
Q18. 在 LLM 中，Encoder-only、Decoder-only、Encoder-Decoder 有什么本质区别？
    面试官为什么问这个问题：  
    考察你是否理解架构与任务的关系。
...
Q19. 为什么 Decoder 中需要 Masked Self-Attention？
    面试官为什么问这个问题：  
    这是生成模型的关键机制。
...
Q20. Feed Forward Network 在 Transformer 中的真实作用是什么？
    面试官为什么问这个问题：  
    很多人会忽略 FFN 的重要性。
...
Q21. LayerNorm 在 Transformer 中解决了什么问题？
    面试官为什么问这个问题：  
    这是训练稳定性的关键。
...
Q22. Self-Attention 在工程上解决了什么“实际问题”？
    面试官为什么问这个问题：  
...
Q23. Multi-Head Attention 在真实项目中带来的价值是什么？
    面试官为什么问这个问题：  
...
Q24. Encoder 和 Decoder 的核心差异，在工程上体现在哪？
    面试官为什么问这个问题：  
...
Q25. Masked Attention 在 LLM 推理阶段到底起了什么作用？
    面试官为什么问这个问题：  
...
Q26. 位置编码在 Transformer 中为什么是“必需但不完美”的？
    面试官为什么问这个问题：  
...
Q28. Transformer 的上下文窗口，本质上限制的是什么？
    面试官为什么问这个问题：  
    这是一个“识别能力边界”的问题。
...
Q29. Prompt 设计为什么本质上是在“顺着 Transformer 的工作方式走”？
    面试官为什么问这个问题：  
...
Q30. Pre-Norm 和 Post-Norm 的差异，你在工程上会怎么选？
    面试官为什么问这个问题：  
...
Q31. LayerNorm、RMSNorm 这类归一化选择，为什么会影响推理性能和稳定性？
    面试官为什么问这个问题：  
...
Q32. GELU、SwiGLU 这类激活/门控设计，在 Transformer 里为什么值得面试官问？
    面试官为什么问这个问题：  
...
Q33. Multi-Query / Grouped-Query Attention（MQA/GQA）为什么在工程上很重要？
    面试官为什么问这个问题：  
...
Q34. Attention 的 softmax 为什么在数值上容易出问题？你怎么做工程兜底？
    面试官为什么问这个问题：  
...
Q35. 为什么说“输出层的 logits 处理”也是 Transformer 系统的一部分工程能力？
    面试官为什么问这个问题：  
...
Q36. Transformer 训练阶段和推理阶段最大的差异是什么？
    面试官为什么问这个问题：  
    这是工程落地的基础问题。
...
Q43. Transformer 中你如何理解“参数共享”的价值？
    面试官为什么问这个问题：  
    这是模型设计哲学问题。
...
Q44. Transformer 推理阶段最大的性能瓶颈通常在哪里？
    面试官为什么问这个问题：  
...
Q45. KV Cache 的本质是什么？为什么它对 Transformer 推理这么关键？
    面试官为什么问这个问题：  
    这是区分“用过”和“调过”的关键问题。
...
Q46. 长上下文下，Attention 开销为什么会成为系统问题？
    面试官为什么问这个问题：  
    这是在考你是否具备系统级思维。
...
Q47. 批量推理（Batching）对 Transformer 服务意味着什么权衡？
    面试官为什么问这个问题：  
    这是一个“吞吐 vs 延迟”的经典问题。
...
Q48. Transformer 服务化时，为什么常常需要请求队列和调度？
    面试官为什么问这个问题：  
    这是在考你是否做过生产系统。
...
Q49. 你如何理解 Transformer 输出“漂移”或不稳定的问题？
    面试官为什么问这个问题：  
    这是在考你对模型行为的工程认知。
...
Q50. Transformer 在 Docker / API 化部署时，最容易被忽视的点是什么？
    面试官为什么问这个问题：  
    这是一个“踩坑经验题”。
...
Q51. 为什么说 Transformer 系统必须“以失败为前提设计”？
    面试官为什么问这个问题：  
    这是高级工程师常见的思维方式。
...
Q52. FlashAttention 这类优化，本质上在优化 Transformer 的哪一块成本？
    面试官为什么问这个问题：  
...
Q53. Tensor Parallel / Pipeline Parallel 在 Transformer 上为什么好用？你怎么选切分点？
    面试官为什么问这个问题：  
...
Q54. 为什么量化对 Transformer 的影响常常“不是均匀的”？你会优先保护哪部分？
    面试官为什么问这个问题：  
...
Q55. 为什么推理延迟常常呈现“首 token 慢、后续 token 快”或反过来？你怎么定位？
    面试官为什么问这个问题：  
...
Q56. Speculative Decoding 这类“推理加速”思路，为什么对 Transformer 特别有效？
    面试官为什么问这个问题：  
...
Q57. MoE（Mixture-of-Experts）放在 Transformer 里，工程上最难的点是什么？
    面试官为什么问这个问题：  
...
### 第四层：真实项目与业务场景能力【16 题】

Q58. Transformer 架构本身是否具备“逻辑推理能力”？
    面试官为什么问这个问题：  
    这是对 LLM 认知理性的考察。
...
Q60. Transformer 对“世界模型”的表达能力有什么局限？
    面试官为什么问这个问题：  
    这是能力边界问题。
...
Q61. 在工程上，如何弥补 Transformer 的事实不确定性？
    面试官为什么问这个问题：  
    这是 LLM 应用落地的关键。
...
Q63. 你如何在系统设计中限制 Transformer 的“自由度”？
    面试官为什么问这个问题：  
    这是工程控制能力问题。
...
Q64. 在真实业务中，你通常如何判断“该不该用 Transformer”？
    面试官为什么问这个问题：  
    这是在考你是否具备技术选型能力。
...
Q65. Transformer 在企业知识库 / RAG 中的真实角色是什么？
    面试官为什么问这个问题：  
    这是在考你是否理解 RAG 的本质。
...
Q66. 在医疗或金融场景中，Transformer 最大的风险点是什么？
    面试官为什么问这个问题：  
    这是在考风险意识。
...
Q67. 你在项目中是如何降低 Transformer 幻觉的？
    面试官为什么问这个问题：  
    这是一个非常实战的问题。
...
Q68. 有没有遇到过 Transformer“答非所问”的情况？你怎么处理？
    面试官为什么问这个问题：  
    这是在考你是否真的踩过坑。
...
Q69. 你如何向业务解释 Transformer 的“能力边界”？
    面试官为什么问这个问题：  
    这是技术与业务沟通能力的体现。
...
Q70. 你在 RAG 项目里遇到过“检索命中但回答仍然偏”的情况吗？你会从 Transformer 视角怎么排查？
    面试官为什么问这个问题：  
...
Q71. 做企业问答时，你怎么用“结构化输出”去约束 Transformer，而不是靠口头要求？
    面试官为什么问这个问题：  
...
Q72. 当业务方要求“必须可追溯、必须可解释”时，你如何从 Transformer 架构角度给出可落地方案？
    面试官为什么问这个问题：  
...
Q73. 你怎么判断一个候选人是不是“只会调 Prompt 的 Transformer 使用者”？
    面试官为什么问这个问题：  
...
Q74. 你如何看待 Transformer 是否会被“下一代架构”取代？
    面试官为什么问这个问题：  
    这是技术趋势判断题。
...
Q75. 对 AI 应用工程师来说，理解 Transformer 的“哪一层”最重要？
    面试官为什么问这个问题：  
    这是岗位匹配度问题。
...
Q76. 面试官通过 Transformer 问题，最想判断你什么？
    面试官为什么问这个问题：  
    这是综合心理判断题。
...
Q77. 在 LangChain / LangGraph 的 Agent 或 Workflow 里，你如何定位 Transformer 的职责边界？哪些必须交给系统而不模型？】
...
Q78. 在 LangChain / LangGraph 的 Agent 或 Workflow 里，你如何定位 Transformer 的职责边界？哪些必须交给系统而不模型？】
...
Q6. 你怎么判断一个需求“必须用多模态”，而不是“被多模态吸引”
...
Q12. Vision Encoder 在系统里通常是瓶颈还是工具
...
Q13. 多模态 Prompt 和纯文本 Prompt 最大的工程差异是什么
...
Q17. 多模态 Agent 相比普通 Agent，多出来的复杂度在哪里
...
Q21. 音频模态在多模态 LLM 中最容易被低估的问题是什么
...
Q24. 多模态 Agent 的“观察（Observation）”阶段有什么特殊性
...
### 第四层：真实项目与业务场景能力【12 题】

Q43. 在医疗场景中，多模态最容易踩的坑是什么
...
Q56. 你怎么看 LangGraph 在多模态流程中的价值与限制
...
Q8. 为什么说 Agent 更像“系统组件”，而不是“智能助手”？
...
Q10. 在你看来，一个 Agent 项目失败，最常见的原因是什么？
...
Q11. 你能从运行机制角度，描述一次 LangChain Agent 的完整执行过程吗？
...
Q12. Tool / Function Calling 在真实业务中最大的设计难点是什么？
...
Q13. Prompt 在 Agent 决策中真实起到什么作用？它的边界在哪里？
...
Q14. 你在 Agent 中如何使用 Memory？踩过哪些坑？
...
Q15. LangChain + RAG 在 Agent 中是如何配合的？
...
Q18. 当 Agent 输出结果质量波动很大时，你会从哪些维度排查？
...
Q20. 你如何避免 Agent 在多个 Tool 之间来回震荡？
...
Q21. 你是否会让 Agent 自己选择使用哪一个 RAG 数据源？
...
Q22. 你如何设计 Tool 的返回结果，才能“更适合 Agent 使用”？
...
Q24. 当 Agent 调用 Tool 后返回“异常但不报错”的结果，你如何处理？
...
Q26. 你是否遇到过 Agent “理解对但执行错”的情况？怎么解决？
...
Q40. 你如何防止 Agent 被 Prompt Injection 利用？
...
Q48. Human-in-the-loop 你通常放在哪一层？
...
Q49. 你是否遇到过业务方要求“Agent 替代人工岗位”？你如何应对？
...
Q50. 在高风险业务中，你如何向业务方证明 Agent 是“安全的”？
...
Q54. 当 Agent 给出错误建议导致业务损失，你如何复盘？
...
Q56. 你为什么会从 LangChain 迁移到 LangGraph / Workflow？
...
Q57. 在你看来，什么样的人是“有 Agent 潜力的工程师”？
...
Q6. 为什么说“状态不可见”的 Agent，本质上是不可治理的？
...
Q7. 你如何理解 LangGraph 中“流程确定性”和“模型不确定性”的关系？
...
Q8. 为什么说 LangGraph 更适合“失败优先”思维，而不是“成功优先”？
...
Q9. 你如何向非技术同事解释“Graph 化 Agent”这件事？
...
Q10. LangGraph 中“流程可控”与“模型自由度”你如何取舍？
...
Q11. 你在项目中通常如何设计 LangGraph 的 State 结构？
...
Q13. 你如何使用 Conditional Edge 来限制 Agent 的决策范围？
...
Q14. 你在什么场景下会使用 LangGraph 的 Interrupt 机制？
...
Q17. LangGraph 如何与 RAG 协同，避免幻觉扩散？
...
Q19. 你是否在 State 中区分过“事实状态”和“推理状态”？为什么？
...
Q21. 你是否遇到过 Conditional Edge 规则膨胀的问题？如何解决？
...
Q27. LangGraph 系统上线后，你如何做执行过程的可观测性？
...
Q30. LangGraph 在高并发场景下，State 存储你如何权衡？
...
Q34. 你遇到过最难排查的一次 LangGraph 线上问题是什么？
...
Q35. 在医疗场景中，LangGraph 的核心价值体现在哪？
...
Q36. 金融多步骤分析中，你如何用 LangGraph 防止错误结论扩散？
...
Q37. 企业审批流中，LangGraph 相比传统流程的优势是什么？
...
Q42. 你如何看待 LangChain → LangGraph → Agent Platform 的演进？
...
Q6. 【你如何向新人解释：为什么 LlamaIndex 是“数据框架”，而不是“RAG 工具集”？】
...
Q7. 【如果不用 LlamaIndex，你认为 RAG 系统最容易失控的点在哪里？】
...
Q8. 【你如何理解 LlamaIndex 中“索引”与传统数据库索引的差异？】
...
Q10. 【在你看来，什么情况下“不该上 RAG / LlamaIndex”？】
...
Q11. 【在什么场景下你会选择 Vector Index，而不是其他类型的 Index？】
...
Q12. 【Chunk 策略在你做过的项目中，对结果质量产生过哪些直接影响？】
...
Q13. 【你如何设计 Node 的 Metadata，来约束 Agent 的行为？】
...
Q14. 【Query Engine 和 Retriever 在你理解中，各自解决什么问题？】
...
Q15. 【你是如何在 LlamaIndex 中做多阶段召回或过滤的？】
...
Q16. 【LlamaIndex 在 Agent 中通常承担什么角色？】
...
Q20. 【Node 设计不合理，通常会在 Agent 行为上体现为哪些问题？】
...
Q21. 【你如何控制一次 Query 中，Node 被选中的“上限与下限”？】
...
Q22. 【你如何理解 LlamaIndex 中“可组合检索策略”的价值？】
...
Q24. 【你如何在 LlamaIndex 中处理“强时效性数据”？】
...
Q26. 【你是否在 LlamaIndex 中用过非文本数据？如何处理的？】
...
Q31. 【LlamaIndex 在服务化部署中通常以什么形式存在？】
...
Q33. 【当 Agent 输出不符合预期时，你通常如何定位问题？】
...
Q34. 【你如何评估一个 LlamaIndex RAG 系统是否“稳定可用”？】
...
Q43. 【你在真实业务中用 LlamaIndex 解决过哪些“知识问题”？】
...
Q46. 【在企业内部文档杂乱的情况下，你如何逐步提升 RAG 质量？】
...
Q49. 【你是否经历过“业务不信任 Agent”的阶段？如何解决的？】
...
Q51. 【你如何评估“这个 Agent 是否真的在用知识，而不是在猜”？】
...
Q52. 【在合规要求很高的场景，你如何限制 Agent 的回答边界？】
...
Q56. 【你如何看待 LlamaIndex 与 LangGraph 的结合点？】
...
Q57. 【从单一 RAG 项目到企业知识平台，你认为演进的关键是什么？】
...
Q6. 你如何判断一个 Agent 项目“是否已经到了必须引入 MCP 的阶段”？
...
Q7. 为什么说 MCP 本质上是“制度化”的，而不是“技术炫技”？
...
Q10. 如果没有 MCP，你认为 Agent 最容易在哪些地方失控？
...
Q11. 在你理解中，MCP Server 和 Client 的职责边界是什么？
...
Q12. 你如何理解 MCP 中 Tool、Resource、Prompt 这三类抽象？
...
Q14. MCP 在 Agent 的决策与执行链路中，处在什么位置？
...
Q15. 多 MCP Server 共存时，你是如何做路由和选择的？
...
Q18. 你如何看待 MCP 与 LangChain / LangGraph 的关系？
...
Q19. 你在设计 MCP Tool 时，如何控制参数的“表达能力”？
...
Q26. 你是否会让 MCP Server 动态生成 Tool？
...
Q32. MCP 如何与 API Gateway 或内网系统结合？
...
Q34. 你如何评估一个 MCP Server 是否“设计得足够安全”？
...
Q36. 你是否会为不同风险等级的工具拆分 MCP Server？
...
Q43. 在医疗场景中，你如何用 MCP 控制 Agent 行为？
...
Q51. 你是否遇到过业务要求“给 Agent 更大权限”？如何应对？
...
Q55. 在多 Agent 系统中，MCP 的角色会发生变化吗？
...
Q56. 你如何将 MCP 与 LangGraph 的 Workflow 结合？
...
Q6. 【你第一次意识到“单 Agent 不够用”是因为什么问题？】
...
Q10. 【你是否遇到过“为了多智能体而多智能体”的项目？结果如何？】
...
Q49. 【在金融风控中，多智能体最大的价值和最大风险分别是什么？】
...
Q50. 【你是否在企业内部系统中替换过人工流程为多智能体？结果如何？】
...
#### 第五层：进阶与加分项（架构 / 视野）【6 题】

Q55. 【你如何将多智能体与 LangChain / LangGraph 结合？】
...
Q9. 在你看来，AI 应用和传统规则系统最大的上线差异是什么？
    面试官为什么问这个问题：  
    考察是否真正做过从规则到模型的迁移。
...
### 第二层：核心部署技术能力（How）【16 题】

Q11. 你通常如何把 LLM / RAG / Agent 系统服务化？
    面试官为什么问这个问题：  
...
Q12. FastAPI / Flask / Gunicorn 在 AI 推理服务中你如何选？
    面试官为什么问这个问题：  
...
Q33. Docker Compose 和 K8s 在 AI 项目中如何取舍？
    面试官为什么问这个问题：  
    防止“无脑 K8s”。
...
Q55. 多 Agent / Workflow 系统在部署上最大的复杂性是什么？
    面试官为什么问这个问题：  
    区分普通工程师和架构型选手。
...
Q56. LangChain / LangGraph 在生产部署中有哪些真实问题？
    面试官为什么问这个问题：  
    考察是否真用过。
...
Q23. Agent 工具调用成功，但结果仍不可用，你会监控什么？
...
Q27. 在 AI 系统中，你如何划分日志、指标和 Trace 的职责？
...
Q31. 在 Docker 化部署下，你如何设计 AI 应用监控？
...
Q55. 多 Agent / Workflow 场景下，监控最大的难点是什么？
...
Q56. 你如何看待 LangChain / LangGraph 在可观测性上的现实问题？
