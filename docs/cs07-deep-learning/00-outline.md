...
To use this course, go through each chapter sequentially.  Read the lessons. Look through the implementations to solidify your understanding, and recreate them on your own.
...
- [Course intro](http://127.0.0.1:8000/deeplearning/00-outline/)
...
<!-- - [Lesson](http://127.0.0.1:8000/deeplearning/03-dense) -->
